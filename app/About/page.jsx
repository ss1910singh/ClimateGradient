...
const AboutPage = () => {
	...
	const api =
		'https://sheet.best/api/sheets/7c537f55-1fbd-4623-bd8e-52abe2f4becb'
	...
	return (
		<div className='bg-gradient-to-b from-sky-400 to-sky-200min-h-screen py-8 md:py-20 px-4 text-center '>
			<div className='max-w-screen-lg mx-auto'>
				<h1 className='text-3xl md:text-5xl lg:text-6xl font-extrabold mb-2 md:mb-6'>
					About Us
				</h1>
				<p className='text-base md:text-lg'>
					Welcome to <strong>ClimateGradient</strong>. Our mission is
					to provide a powerful platform for global cooperation and
					policy analysis in addressing climate change. With real-time
					data updates and a user-friendly interface, we aim to make a
					positive impact on the world&apos;s environmental
					challenges.
				</p>
			</div>
			...
			<div className='w-full md:w-screen-lg mx-auto p-4 bg-white rounded-lg shadow-lg flex bg-gradient-to-b from-gray-900 to-gray-600 bg-gradient-to-r '>
				<section className='mb-4 md:mb-12 w-full md:w-1/2 pr-4 border-r border-gray-300 pr-4'>
					...
					<p className='text-base md:text-lg text-center'>
						Climate change is an urgent global issue. Our mission is
						to create a sustainable future by promoting adaptability
						to environmental challenges and reducing ecological
						footprints. Every action on this platform contributes to
						a better world for all. As the planet faces rising
						temperatures and extreme weather, it is our collective
						responsibility to tackle climate change. Through
						awareness and sustainable practices, we empower
						individuals and communities to combat this existential
						threat. Our commitment to environmental stewardship
						safeguards biodiversity, ensuring a resilient world
						where all beings thrive. Together, we can secure a
						sustainable future, preserving the planet&apos;s health
			...
			<div className='flex flex-col items-center justify-center h-screen'>
				{isSubmitted ? (
					...
					<form
						...
						className='bg-white rounded-lg p-6 shadow-md w-96'>
						<h2 className='text-2xl font-semibold mb-4 text-black'>
							Feedback
						</h2>
						<input
			...
			<div className='text-white'>
				This website extracts and utilizes publicly available reports
				and data from various national and international institutions,
